...
def plot1_2(dark):
    ...
    spline0 = spline_get_cubic(t0, p0, v0, t1, p1, v1)
    tspan0 = np.linspace(t0, t1, 100)
    x0 = poly_eval(spline0, tspan0)

    spline1 = spline_get_cubic(t1, p1, v1, t2, p2, v2)
    tspan1 = np.linspace(t1, t2, 100)
    x1 = poly_eval(spline1, tspan1)

    spline2 = spline_get_cubic(t2, p2, v2, t3, p3, v3)
...
def plot2_3(dark):
    ...
    def draw_spline(p0, v0, p1, v1, color):
        spline = spline_get_cubic(0.0, p0, v0, 1.0, p1, v1)
